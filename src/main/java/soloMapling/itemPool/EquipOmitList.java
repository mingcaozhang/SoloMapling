 ...
 *
 * Data lives in EquipOmitList.yaml in src/main/resources/soloMapling/... - add
 * or remove ids there,
 * no code change needed. Set "enabled: false" in the YAML to turn the whole
 * list
...
public class EquipOmitList {
    ...
    private static final String YAML_PATH = "soloMapling/itemPool/EquipOmitList.yaml";
    ...
    public static synchronized void load() {
        ...
        try (InputStream inputStream = EquipOmitList.class.getClassLoader().getResourceAsStream(YAML_PATH)) {
            if (inputStream == null) {
